...
1. **Clone and Compiling ROS Package for RS Lidar SDK:**
   ...
   - To compile using catkin_make method, open **CMakeLists.txt** and set the variable COMPILE_METHOD to CATKIN.
      <img src="https://github.com/syedmohiuddinzia/ros_robosense_rubyplus/blob/main/images/6.png" alt="rosrun" width="750"/>
   - If you are setting up **RS Lidar Ruby Plus**, then open **config.yaml** file in **rslidar_sdk/config** directory. And write in **lidar_type:** ```RSP80```.
...
```
After ROS launching the RS-Lidar SDK, RVIZ will open with pointcloud data. The pointcloud topic /rslidar_points is published now.
<img src="https://github.com/syedmohiuddinzia/ros_robosense_rubyplus/blob/main/images/8.png" alt="rosrun" width="750"/>
...
/tf_static
```
   <img src="https://github.com/syedmohiuddinzia/ros_robosense_rubyplus/blob/main/images/350.png" alt="rosrun" width="750"/>
